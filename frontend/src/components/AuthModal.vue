  ...
  <div class="modal-overlay" role="dialog" aria-modal="true" @click.self="showAuthModal = false">
    <div class="auth-modal">
      <div class="auth-modal-header">
        <button class="modal-close" type="button" aria-label="닫기" @click="showAuthModal = false">
      ...
      <div class="auth-tabs">
        <button :class="{ active: authMode === 'login' }" type="button" @click="authMode = 'login'; authError = ''">
          <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <button :class="{ active: authMode === 'register' }" type="button" @click="authMode = 'register'; authError = ''">
          <svg viewBox="0 0 24 24" aria-hidden="true">
