...
TOP100 = [
    ...
    "가지산","문복산","영축산","고헌산","황석산",
    # 추가 산 (충돌 없는 고유 이름만, 좌표 검증 완료)
    "삼성산","수리산","검단산","예봉산","유명산","축령산","주금산","소요산",
    "무갑산","운길산","천보산","왕방산","박달산","상원산",
    "계방산","노인봉","매봉산","금대봉","가칠봉",
    "용봉산","덕숭산","서산가야산","도락산","황학산","금수산","제비봉","구병산",
    "희양산","군자산","낙영산",
    "봉화청량산","일월산","학가산","문경황장산","갑장산","단석산","팔봉산",
    "남덕유산","웅석봉","삼봉산","달음산","광려산","정병산","방어산","천황산","미륵산",
    "신어산","불모산",
    "백운산","모악산","방장산","입암산","강천산","추월산","병풍산","봉황산",
    "제암산","금전산","백아산",
    "성산일출봉","산방산",
]
