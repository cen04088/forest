...
**날씨** (`_weather_score`, 0.0~1.0): 코스 날씨 점수와 동일 방식. 강수·풍속·기온·불쾌지수·PM2.5·산불위험 복합 감점.
...
**이동 거리** (`_distance_score`, 0.0~1.0): 선형 보간, 사용자 설정 max_km 초과 시 추가 페널티
...
- **모델**: Gemini 2.5 Flash Lite — `gemini-2.5-flash-lite` (chat_ai.py, safety_advice_ai.py)
